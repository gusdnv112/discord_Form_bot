...
import { Intents, Interaction, Message, Formatters } from "discord.js";
...
client.on('modalSubmit', async (modal : ModalSubmitInteraction) => {
  if(modal.customId === 'customid'){
    ...
    modal.followUp({ content: Formatters.codeBlock('markdown', firstResponse) + Formatters.codeBlock('markdown', twitter), ephemeral: true })
  }  
});
